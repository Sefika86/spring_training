...
//        PC myPc2 = new PC(theCase,theMonitor,theMotherboard);
        ...
        //but if we have more than one method that return different type of monitors, this will give me exception
        //we have 3 ways to solve this:

        Monitor theMonitor2 = container.getBean("monitorSony", Monitor.class);  //DEFAULT BEAN NAME (as method's name itself)
        Monitor theMonitor3 = container.getBean("sony", Monitor.class);  //CUSTOM BEAN NAME ( @Bean(name="sony2"))
        Monitor theMonitor4 = container.getBean( Monitor.class);  //@Primary annotation on Primary method
